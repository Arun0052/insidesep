...
class Sep_dashboard_Serilizaer(serializers.Serializer):
    ...
    ETPR_ACRONYM = serializers.CharField(allow_blank=True)
    ...
    Tye = serializers.CharField(allow_blank=True)
    Radio_Tech = serializers.CharField(allow_blank=True)
    ...
    def update(self, instance, validated_data):
        ...
        instance.ETPR_ACRONYM = validated_data.get('ETPR_ACRONYM',instance.ETPR_ACRONYM)
        ...
        instance.Tye = validated_data.get('Tye',instance.Tye)
        instance.Radio_Tech = validated_data.get('Radio_Tech',instance.Radio_Tech)
