...
class Sep_dashboard(models.Model):
    ...
    ETPR_ACRONYM=models.CharField(max_length=200,blank=True)
    ...
    Tye=models.CharField(max_length=200,blank=True)
    Radio_Tech=models.CharField(max_length=200,blank=True)
